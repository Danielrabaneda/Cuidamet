    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <main className="container mx-auto px-4 py-6 pb-28">
        ...
        <section className="mb-6">
            ...
            >
                <div>
                    <h3 className="text-lg font-bold text-slate-800">Tus Estadísticas</h3>
                    <p className="text-sm text-slate-500">Pulsa para ver tu rendimiento</p>
                </div>
                ...
                <button className="w-full flex items-center justify-between text-left">
                    <div>
                        <h3 className="font-bold text-lg text-slate-800 flex items-center">
                            ...
                            Valoraciones a Familias
                        </h3>
                        <p className="text-sm text-slate-500 mt-1">Ver las valoraciones que has dejado a las familias.</p>
                    </div>
                    <ChevronRightIcon className="w-5 h-5 text-slate-400" />
                </button>
            </section>
